...
const FAQ_ITEMS = [
  ...
  { q: 'What happens when a prayer request expires?', a: 'After the auto-dismiss period (1 month, 6 months, or 1 year), the request is automatically removed. An AI-generated prayer is sent to the requester.' },
              ...
              {FAQ_ITEMS.map((item, index) => (
                <View key={index}>
                  ...
                  >
                    ...
                    {expandedFaq === index ? (
                      <ChevronUp size={18} color="#6B4F3E" />
                    ) : (
                      <ChevronDown size={18} color="#9B7B6A" />
                    )}
                  </TouchableOpacity>
                  {expandedFaq === index && (
